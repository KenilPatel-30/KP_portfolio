...
const workItems: WorkItem[] = [
  {
    ...
    description: 'A professional and elegant certificate design recognizing invaluable contribution as Resource Head for Ananta\'24.',
    tags: ['Certificate Design', 'Typography', 'Official Document'],
  ...
  },
  {
    ...
    tags: ['Large Format Print', 'Event Branding', 'Visual Hierarchy'],
  ...
  },
  {
    ...
    tags: ['Stationery Design', 'Cover Design', 'Illustration'],
  ...
  },
  {
    ...
    tags: ['Editorial Design', 'Layout Design', 'Typography'],
    gradient: 'from-primary/20 via-secondary to-muted',
  ...
  },
  {
    ...
    category: 'Print Design',
    mediaType: 'Digital & Print Media',
    description: 'A highly engaging promotional flyer designed to capture attention and deliver clear marketing messaging.',
    tags: ['Marketing', 'Promotional', 'Layout Design'],
  ...
  },
  {
    ...
    tags: ['Brochure Design', 'Information Design', 'Print Media'],
    gradient: 'from-secondary via-muted to-primary/10',
  ...
  },
  {
    ...
    mediaType: 'Digital & Print Media',
    description: 'A professional and elegant business card design focusing on brand identity, clean typography, and visual hierarchy.',
    tags: ['Print Design', 'Brand Identity', 'Typography'],
    gradient: 'from-muted via-primary/15 to-secondary',
  ...
  },
  {
    ...
    tags: ['Apparel Design', 'Merchandise', 'Typography'],
    gradient: 'from-primary/20 via-secondary to-muted',
  ...
  },
  {
    ...
    category: 'Brand Identity',
    mediaType: 'Digital & Print Media',
    description: 'A sleek and professional corporate ID card design ensuring clear identification and brand consistency.',
    tags: ['Corporate Identity', 'Print Design', 'Typography'],
  ...
  },
  {
    ...
    tags: ['Poster Design', 'Event Branding', 'Visual Impact'],
    gradient: 'from-primary/20 via-secondary to-muted',
  ...
  },
  {
    ...
    tags: ['Badge Design', 'Event Branding', 'Identity'],
    gradient: 'from-secondary via-muted to-primary/10',
